...
public class PddCatsIconAdapter extends RecyclerView.Adapter<PddCatsIconAdapter.ViewHolder> {
    ...
    public PddCatsIconAdapter(Context context, List<PddGoodsCat> list) {
    ...
    @NonNull
    @Override
    public PddCatsIconAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_pdd_goods_cat, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PddCatsIconAdapter.ViewHolder holder, int position) {
        PddGoodsCat cat = list.get(position);
        holder.mIvCat.setImageResource(cat.getIcon());
        holder.mTvCat.setText(cat.getCat_name());
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            mTvCat = itemView.findViewById(R.id.tv_cat_name);
            mIvCat = itemView.findViewById(R.id.iv_cat_icon);
        }
    }
